...
public class SearchSupplier extends javax.swing.JFrame {
    ...
    Main_menu menu;
    GRN_RawMaterial rawGRN;
    Supplier_payment pay;

    boolean searchFromRawGRN = false;
    ...
    public SearchSupplier(Main_menu menu, GRN_RawMaterial grn) {
        this();
        searchFromRawGRN = true;
        this.rawGRN = grn;
    }
    
    public SearchSupplier(Main_menu menu, Supplier_payment supPay) {
        this();
        searchFromRawGRN = true;
        this.pay = supPay;
    }
    ...
    private void initComponents() {
        ...
        header.setText("  Search Supplier");
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        ...
        if (evt.getClickCount() == 2) {
            try {
                ...
                if (searchFromRawGRN) {
                    rawGRN.supplierID.setText(ID);
                    rawGRN.supplierName.setText(name);
                }
                this.dispose();
            } catch (Exception e) {
    ...
    private void loadTableData() {
        try {
            DefaultTableModel dtm = (DefaultTableModel) table.getModel();
            ResultSet rs = DB.search("SELECT id_supplier, company, city, mobile FROM supplier WHERE state = 1");
            dtm.setRowCount(0);
            while (rs.next()) {
                Vector v = new Vector();
                v.add(rs.getString("id_supplier"));
