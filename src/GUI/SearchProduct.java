...
public class SearchProduct extends javax.swing.JFrame {
    ...
    boolean searchFromRawCostCal = false;
    boolean searchFromBOM = false;
    boolean searchFromProGRN = false;
    ...
    public SearchProduct(Main_menu menu, RawCostCalculation rawCost) {
        this();
        searchFromRawCostCal = true;
        this.menu = menu;
        this.rawCostCalculations = rawCost;
    }

    public SearchProduct(Main_menu menu, BillOfMatrial bom) {
        this();
        searchFromBOM = true;
        this.menu = menu;
        this.bom = bom;
    ...
    public SearchProduct(Main_menu menu, Product_GRN pGRN) {
        this();
        searchFromProGRN = true;
        this.menu = menu;
        this.grn = pGRN;
    }

    public SearchProduct(Main_menu menu, AOD invoice) {
        this();
        searchFromAOD = true;
        this.menu = menu;
        this.inv = invoice;
    ...
    public SearchProduct(Main_menu menu, Sales_return srn) {
        this();
        searchFromAOD = true;
        this.menu = menu;
        this.salesReturn = srn;
    }
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        ...
        if (evt.getClickCount() == 2) {
            try {
                ...
                if (searchFromRawCostCal) {
                    rawCostCalculations.product_Code.setText(ID);
                    rawCostCalculations.productName.setText(name);
                    
                } else if (searchFromBOM) {
                    bom.product_Code.setText(ID);
                    bom.productName.setText(name);
                    bom.getData(ID);
                    
                } else if (searchFromProGRN) {
                    grn.productCode.setText(ID);
                    grn.productName.setText(name);
                    grn.unit.setText((dtm.getValueAt(table.getSelectedRow(), 2)).toString());
                    
                } else if (searchFromAOD) {
                    inv.productCode.setText(ID);
                    inv.productName.setText(name);
                    inv.unit.setText((dtm.getValueAt(table.getSelectedRow(), 2)).toString());
                    inv.loadStockDetails();
                    inv.qty.grabFocus();
                }

                this.dispose();
            } catch (Exception e) {
                JOptionPane.showMessageDialog(this, "Select a row" + e, "Error", 1);
            }
        }
    ...
    private void btn_SelectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_SelectActionPerformed
        ...
        if (table.getSelectedRow() == -1) {
            ...
            try {
                String ID = (dtm.getValueAt(table.getSelectedRow(), 0)).toString();
                String name = (dtm.getValueAt(table.getSelectedRow(), 2)).toString();
