...
public class Add_RawItemCategory extends javax.swing.JFrame {

    int xMouse;
    int yMouse;

    public Add_RawItemCategory() {
        initComponents();
        generateID();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Add Raw Material Category");
        ...
        jPanel1.add(warning_msg, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 150, 280, 15));
    ...
    private void categoryKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_categoryKeyTyped
        Validation.setLength(evt, category.getText(), 50);
    ...
    private void descriptionKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_descriptionKeyTyped
        Validation.setLength(evt, description.getText(), 300);
    ...
    private void btn_AddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_AddActionPerformed
        if (category.getText().equals("")) {
            ...
            if (warning_msg.getText().isEmpty()) {
                try {
                    DB.iud("INSERT INTO raw_category VALUES('" + category_Code.getText() + "','" + category.getText() + "','" + description.getText() + "')");
    ...
    private void categoryKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_categoryKeyReleased
        try {
            ResultSet rs = DB.search("SELECT category FROM raw_category WHERE category='" + category.getText() + "' ");
            if (rs.next()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Add_RawItemCategory.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Add_RawItemCategory().setVisible(true);
            }
        });
    }
    ...
    private void generateID() {
        try {
            ResultSet rs = DB.search("SELECT COUNT(id) AS id FROM raw_category");
            if (rs.next()) {
                int rowcount = rs.getInt("id");
                rowcount++;
                category_Code.setText("RAWC" + String.format("%0" + 4 + "d", rowcount));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
