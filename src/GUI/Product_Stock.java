...
public class Product_Stock extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panel.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 60, 120, 25));
        ...
        panel.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 60, 290, 25));
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Stock ID", "Product ID", "Product Name", "Unit", "Qty"
            }
        ) {
    ...
    private void btn_Export1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_Export1ActionPerformed
        ...
        try {
            String path = "iReport\\product_stock.jrxml";
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        ...
        try {
            ResultSet rs = DB.search("SELECT product_stock.idproduct_stock,product_stock.product_id,product.productname,product.unit,product_stock.qty FROM "
                    + "product INNER JOIN product_stock ON product.id_product=product_stock.product_id where product.productname like '"+jTextField1.getText()+"%'");                           
            dtm.setRowCount(0);
            while (rs.next()) {
                Vector v=new Vector();
